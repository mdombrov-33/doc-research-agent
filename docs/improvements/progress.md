...
| 07 uncached agentic RAG latency | in progress | same-query document answer confirmed; 18.0 s TTFT best observed, 73.1 s provider outlier; uncached p50/p95 proof pending |
